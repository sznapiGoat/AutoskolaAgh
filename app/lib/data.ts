...
export const CATEGORIES = [
  { code: "AM",  name: "Moped",                 min_age: 15, desc: "Mopedy a tříkolky do 45 km/h. Skvělý první krok k mobilitě.",           photo: null },
  { code: "A1",  name: "Malý motocykl",          min_age: 16, desc: "Motocykly do 125 cm³ a 11 kW. Ideální začátek pro motorkáře.",           photo: "/images/moto-track.jpg" },
  { code: "A2",  name: "Střední motocykl",       min_age: 18, desc: "Motocykly do 35 kW. Přirozený přechod z A1 nebo na vlastní pěst.",       photo: "/images/moto-action.jpg" },
  { code: "A",   name: "Motocykl bez omezení",   min_age: 24, desc: "Všechny motocykly. Od 20 let při předchozím A2 (min. 2 roky).",          photo: "/images/moto-road.jpg" },
  ...
  { code: "B+E", name: "Automobil s přívěsem",  min_age: 18, desc: "Vozidla skupiny B s přívěsem nebo návěsem. Podmínkou je platný B průkaz.", photo: "/images/car-instructor.jpg" },
];
...
export const STEPS = [
  {
    ...
    desc: "Domluvíme termín první schůzky. Odpovíme na vše, co potřebujete vědět – bez závazků. Volejte kdykoliv v pracovní dny.",
  ...
  },
  {
    ...
    desc: "Před zahájením výcviku musíte doložit lékařský posudek o zdravotní způsobilosti k řízení. Vydá ho váš praktický lékař – stačí objednat se na prohlídku.",
  ...
  },
  {
    ...
    detail: ["Minimálně 24 hodin teorie", "Závěrečný přezkoušení z teorie"],
  },
  {
    n: 5,
    title: "Jízdní výcvik",
    subtitle: "Praxe za volantem s instruktorem",
    desc: "Nejdůležitější část výcviku – jízda s instruktorem. Pracujeme v malých skupinách, takže máte na sebe dostatek času a instruktor se věnuje přesně vašim potřebám.",
    detail: ["Skupina B: min. 28 jízdních hodin (á 45 min)", "Trénink ve skutečném provozu i na cvičišti"],
  },
  {
    n: 6,
    title: "Závěrečné zkoušky",
    subtitle: "Teorie + praktická jízda před komisí",
  ...
  },
  {
    ...
    subtitle: "Hotovo – jste řidič/ka!",
    desc: "Po úspěšné zkoušce podáte žádost o vydání průkazu na obecním úřadě s rozšířenou působností. Průkaz obdržíte zpravidla do 5–20 pracovních dnů.",
...
export const REVIEWS = [
  ...
  { name: "Jirka R.",        stars: 5, text: "Kdokoliv se v Mostě rozhoduje pro autoškolu – rozhodně touto volbou neprohloupí. Skvělá volba.",               year: "2012" },
...
export const FAQ = [
  { q: "Jak dlouho výcvik trvá?", a: "Průměrně 2–4 měsíce, záleží na vaší dostupnosti a tempu. Neuspěcháme vás, ale nebudeme ani zbytečně protahovat." },
  ...
  { q: "Co když u zkoušky neuspěji?", a: "Nevadí – stane se to i zkušeným žákům. Domluvíme opravný termín a připravíme vás na zopakování. Přezkoušení je samozřejmě možné." },
  { q: "Mohu přerušit výcvik?", a: "Ano, výcvik lze z vážných důvodů přerušit a pokračovat později. Nahlaste nám situaci co nejdříve, vše vyřešíme." },
  { q: "Je nutné umět řídit aspoň trochu?", a: "Ne, bereme úplné začátečníky. Instruktor se přizpůsobí vaší úrovni a trpělivě vás provede vším od základů." },
];
